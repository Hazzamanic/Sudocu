...
namespace Sudocu
{
    class Program
    {
        ...
        {
            string easypuzzle = "000260701680070090190004500820100040004602900050003028009300074040050036703018000";
            string hardpuzzle = "032000005800300000904280001000400039000600050000010000020006708000004000095000060";
            string hardpuzzle2 = "000006000059000008200008000045000000003000000006003054000325006000000000000000000";
            string hard3 = "000050001100000070060000080000004000009010300000596020080062007007000000305070200";
            string mediumpuzzle = "000008100000000006010006450000289340049631005000745060000800013650093782000007094";
            string medium2 = "400000805030000000000700000020000060000080400000010000000603070500200000104000000";
            string impossiblepuzzle = "000006000059000008200008000045000000003000000006003054000325006000000000000000000";
            string hardest1 = "700000400020070080003008079900500300060020090001097006000300900030040060009001035";
            var puzzle = hardest1;

            var sudokus = new List<string> { "480300000000000071020000000705000060000200800000000000001076000300000400000050000" };

            var sudokus2 = new List<string>
            {
